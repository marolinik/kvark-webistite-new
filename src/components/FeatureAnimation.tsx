      ...
      {[1, 2, 3, 4, 5, 6].map((index) => {
        ...
        const cardContent = [
          ...
          },
          {
            ...
            content:
              "Combine your internal data, established templates, and AI-powered refinement to generate polished, reliable content securely and efficiently.",
          },
          {
            icon: limitlessContext,
            header: "Break free from limited context windows",
            content:
              "The limitless Context Board connects semantic search, AI assistance, and drafting into a single intelligence layer, enabling the system to reason over more information and deliver precise, high-fidelity outputs.",
          },
          {
          ...
          },
          {
            ...
            content:
              "Deploy public-facing agents across digital channels to streamline customer interactions and drive top-line growth-without sacrificing governance or oversight.",
          },
        ];
